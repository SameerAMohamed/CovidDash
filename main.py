...
headings = ['date', 'continent', 'location', 'total_cases', 'new_cases', 'total_deaths', 'new_deaths',
                 'total_cases_per_million', 'new_cases_per_million']
df_refined = df[headings]
...
app.layout = html.Div([
    ...
    html.H1("WebApp for COVID Using Dash", style={'text-align': 'center'}),  # title for the webpage header
    html.Div(
        [
